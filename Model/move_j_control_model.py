...
class MoveJControlModel:
    ...
    @staticmethod
    def get_move_j_control_model_from_values(values):
        move_j_control_model = MoveJControlModel()
        move_j_control_model.acceleration = values["Acceleration"]
        move_j_control_model.velocity = values["Velocity"]
        move_j_control_model.time_s = values["TimeS"]
        move_j_control_model.blend_radius = values["BlendRadius"]
